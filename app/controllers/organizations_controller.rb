class OrganizationsController < ApplicationController
    ...
    def create
        ...
        @dk = Doorkeeper::Application.where(name: org_name, organization_id: org_id).first rescue nil
        if @dk.nil?
    ...
    def list
        retVal = [
          {"user-id": 2, "name": "John Doe", "organization-id": 1},
          {"user-id": 3, "name": "Homer Simpson", "organization-id": 1}
        ]
        render json: retVal,
               status: 200
